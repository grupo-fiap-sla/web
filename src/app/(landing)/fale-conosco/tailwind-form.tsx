export function TailwindForm() {
    return (
        <form action="" className="space-y-5 was-validated">
            {/* Nome */}
            <div>
                <label
                    htmlFor="nome"
            ...
            <button
                type="submit"
                className="w-full bg-green-600 text-white font-bold py-3 rounded-md cursor-pointer hover:bg-green-700 transition"
            >
                Enviar
            </button>
        </form>
